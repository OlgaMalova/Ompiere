...
public class X_HR_Movement extends PO implements I_HR_Movement, I_Persistent
{
    ...
    {
      StringBuilder sb = new StringBuilder ("X_HR_Movement[")
	...
	*/
	...
	/** Set HR_Movement_UU.
		@param HR_Movement_UU HR_Movement_UU
	*/
	public void setHR_Movement_UU (String HR_Movement_UU)
	{
		set_Value (COLUMNNAME_HR_Movement_UU, HR_Movement_UU);
	}

	/** Get HR_Movement_UU.
		@return HR_Movement_UU	  */
