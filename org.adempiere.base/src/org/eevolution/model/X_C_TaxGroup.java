...
public class X_C_TaxGroup extends PO implements I_C_TaxGroup, I_Persistent
{
    ...
    /** Standard Constructor */
    public X_C_TaxGroup (Properties ctx, String C_TaxGroup_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, C_TaxGroup_UU, trxName, virtualColumns);
      /** if (C_TaxGroup_UU == null)
        {
			setC_TaxGroup_ID (0);
			setName (null);
