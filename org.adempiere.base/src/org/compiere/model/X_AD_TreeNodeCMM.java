...
@org.adempiere.base.Model(table="AD_TreeNodeCMM")
public class X_AD_TreeNodeCMM extends PO implements I_AD_TreeNodeCMM, I_Persistent
{
    ...
    {
      super (ctx, AD_TreeNodeCMM_ID, trxName);
    ...
    /** Standard Constructor */
    public X_AD_TreeNodeCMM (Properties ctx, int AD_TreeNodeCMM_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, AD_TreeNodeCMM_ID, trxName, virtualColumns);
      /** if (AD_TreeNodeCMM_ID == 0)
        {
			setAD_Tree_ID (0);
			setNode_ID (0);
    ...
    /** Standard Constructor */
    public X_AD_TreeNodeCMM (Properties ctx, String AD_TreeNodeCMM_UU, String trxName)
    {
      super (ctx, AD_TreeNodeCMM_UU, trxName);
      /** if (AD_TreeNodeCMM_UU == null)
        {
			setAD_Tree_ID (0);
			setNode_ID (0);
			setParent_ID (0);
    ...
    /** Standard Constructor */
    public X_AD_TreeNodeCMM (Properties ctx, String AD_TreeNodeCMM_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, AD_TreeNodeCMM_UU, trxName, virtualColumns);
      /** if (AD_TreeNodeCMM_UU == null)
        {
			setAD_Tree_ID (0);
			setNode_ID (0);
    ...
    /** Load Constructor */
    public X_AD_TreeNodeCMM (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_AD_TreeNodeCMM[")
