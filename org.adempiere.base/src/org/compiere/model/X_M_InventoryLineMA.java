...
// 1
    ...
    /** Standard Constructor */
    public X_M_InventoryLineMA (Properties ctx, String M_InventoryLineMA_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, M_InventoryLineMA_UU, trxName, virtualColumns);
      /** if (M_InventoryLineMA_UU == null)
        {
			setM_AttributeSetInstance_ID (0);
			setM_InventoryLine_ID (0);
...
// 1
    ...
    {
      StringBuilder sb = new StringBuilder ("X_M_InventoryLineMA[")
