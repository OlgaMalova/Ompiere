...
@org.adempiere.base.Model(table="AD_TreeNodeU3")
public class X_AD_TreeNodeU3 extends PO implements I_AD_TreeNodeU3, I_Persistent
{
    ...
    /** Standard Constructor */
    public X_AD_TreeNodeU3 (Properties ctx, int AD_TreeNodeU3_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, AD_TreeNodeU3_ID, trxName, virtualColumns);
      /** if (AD_TreeNodeU3_ID == 0)
        {
			setAD_Tree_ID (0);
			setNode_ID (0);
    ...
    /** Standard Constructor */
    public X_AD_TreeNodeU3 (Properties ctx, String AD_TreeNodeU3_UU, String trxName)
    {
      super (ctx, AD_TreeNodeU3_UU, trxName);
      /** if (AD_TreeNodeU3_UU == null)
        {
			setAD_Tree_ID (0);
			setNode_ID (0);
			setParent_ID (0);
    ...
    /** Standard Constructor */
    public X_AD_TreeNodeU3 (Properties ctx, String AD_TreeNodeU3_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, AD_TreeNodeU3_UU, trxName, virtualColumns);
      /** if (AD_TreeNodeU3_UU == null)
        {
			setAD_Tree_ID (0);
			setNode_ID (0);
    ...
    {
      StringBuilder sb = new StringBuilder ("X_AD_TreeNodeU3[")
	...
	*/
	...
	/** Set AD_TreeNodeU3_UU.
		@param AD_TreeNodeU3_UU AD_TreeNodeU3_UU
	*/
	public void setAD_TreeNodeU3_UU (String AD_TreeNodeU3_UU)
	{
		set_Value (COLUMNNAME_AD_TreeNodeU3_UU, AD_TreeNodeU3_UU);
	}

	/** Get AD_TreeNodeU3_UU.
		@return AD_TreeNodeU3_UU	  */
	public String getAD_TreeNodeU3_UU()
	{
		return (String)get_Value(COLUMNNAME_AD_TreeNodeU3_UU);
	}
