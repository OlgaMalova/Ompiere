...
public class X_M_MovementLineMA extends PO implements I_M_MovementLineMA, I_Persistent
{
    ...
    /** Standard Constructor */
    public X_M_MovementLineMA (Properties ctx, int M_MovementLineMA_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, M_MovementLineMA_ID, trxName, virtualColumns);
      /** if (M_MovementLineMA_ID == 0)
        {
			setM_AttributeSetInstance_ID (0);
			setM_MovementLine_ID (0);
    ...
    /** Standard Constructor */
    public X_M_MovementLineMA (Properties ctx, String M_MovementLineMA_UU, String trxName)
    {
      super (ctx, M_MovementLineMA_UU, trxName);
      /** if (M_MovementLineMA_UU == null)
        {
			setM_AttributeSetInstance_ID (0);
			setM_MovementLine_ID (0);
        } */
    ...
    /** Standard Constructor */
    public X_M_MovementLineMA (Properties ctx, String M_MovementLineMA_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, M_MovementLineMA_UU, trxName, virtualColumns);
      /** if (M_MovementLineMA_UU == null)
        {
			setM_AttributeSetInstance_ID (0);
			setM_MovementLine_ID (0);
    ...
    {
      StringBuilder sb = new StringBuilder ("X_M_MovementLineMA[")
