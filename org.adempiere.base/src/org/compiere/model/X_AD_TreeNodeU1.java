...
@org.adempiere.base.Model(table="AD_TreeNodeU1")
public class X_AD_TreeNodeU1 extends PO implements I_AD_TreeNodeU1, I_Persistent
{
    ...
    /** Standard Constructor */
    public X_AD_TreeNodeU1 (Properties ctx, String AD_TreeNodeU1_UU, String trxName)
    {
      super (ctx, AD_TreeNodeU1_UU, trxName);
      /** if (AD_TreeNodeU1_UU == null)
        {
			setAD_Tree_ID (0);
			setNode_ID (0);
			setParent_ID (0);
    ...
    /** Standard Constructor */
    public X_AD_TreeNodeU1 (Properties ctx, String AD_TreeNodeU1_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, AD_TreeNodeU1_UU, trxName, virtualColumns);
      /** if (AD_TreeNodeU1_UU == null)
        {
			setAD_Tree_ID (0);
			setNode_ID (0);
    ...
    /** Load Constructor */
    public X_AD_TreeNodeU1 (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_AD_TreeNodeU1[")
	...
	*/
	...
	/** Set AD_TreeNodeU1_UU.
		@param AD_TreeNodeU1_UU AD_TreeNodeU1_UU
	*/
	public void setAD_TreeNodeU1_UU (String AD_TreeNodeU1_UU)
	{
		set_Value (COLUMNNAME_AD_TreeNodeU1_UU, AD_TreeNodeU1_UU);
	}

	/** Get AD_TreeNodeU1_UU.
		@return AD_TreeNodeU1_UU	  */
	public String getAD_TreeNodeU1_UU()
	{
		return (String)get_Value(COLUMNNAME_AD_TreeNodeU1_UU);
	}
