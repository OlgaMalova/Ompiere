...
public class X_M_CostQueue extends PO implements I_M_CostQueue, I_Persistent
{
    ...
    /** Standard Constructor */
    public X_M_CostQueue (Properties ctx, String M_CostQueue_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, M_CostQueue_UU, trxName, virtualColumns);
      /** if (M_CostQueue_UU == null)
        {
			setC_AcctSchema_ID (0);
			setCurrentCostPrice (Env.ZERO);
