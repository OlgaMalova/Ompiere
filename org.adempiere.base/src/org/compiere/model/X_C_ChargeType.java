...
public class X_C_ChargeType extends PO implements I_C_ChargeType, I_Persistent
{
    ...
    /** Standard Constructor */
    public X_C_ChargeType (Properties ctx, String C_ChargeType_UU, String trxName)
    {
      super (ctx, C_ChargeType_UU, trxName);
      /** if (C_ChargeType_UU == null)
        {
			setC_ChargeType_ID (0);
			setName (null);
			setValue (null);
    ...
    /** Standard Constructor */
    public X_C_ChargeType (Properties ctx, String C_ChargeType_UU, String trxName, String ... virtualColumns)
    {
    ...
    /** Load Constructor */
    public X_C_ChargeType (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_C_ChargeType[")
