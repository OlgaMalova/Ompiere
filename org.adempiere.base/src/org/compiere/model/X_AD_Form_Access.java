...
public class X_AD_Form_Access extends PO implements I_AD_Form_Access, I_Persistent
{
    ...
    /** Standard Constructor */
    public X_AD_Form_Access (Properties ctx, String AD_Form_Access_UU, String trxName)
    {
      super (ctx, AD_Form_Access_UU, trxName);
      /** if (AD_Form_Access_UU == null)
        {
			setAD_Form_ID (0);
			setAD_Role_ID (0);
			setIsReadWrite (false);
    ...
    /** Standard Constructor */
    public X_AD_Form_Access (Properties ctx, String AD_Form_Access_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, AD_Form_Access_UU, trxName, virtualColumns);
      /** if (AD_Form_Access_UU == null)
        {
			setAD_Form_ID (0);
			setAD_Role_ID (0);
