...
// @SQL=SELECT CASE WHEN '@P|AdempiereSys:N@'='Y' THEN 'D' ELSE get_sysconfig('DEFAULT_ENTITYTYPE','U',0,0) END FROM Dual
    ...
    /** Standard Constructor */
    public X_AD_ReportView (Properties ctx, String AD_ReportView_UU, String trxName)
    {
      super (ctx, AD_ReportView_UU, trxName);
      /** if (AD_ReportView_UU == null)
        {
			setAD_ReportView_ID (0);
			setAD_Table_ID (0);
			setEntityType (null);
// @SQL=SELECT CASE WHEN '@P|AdempiereSys:N@'='Y' THEN 'D' ELSE get_sysconfig('DEFAULT_ENTITYTYPE','U',0,0) END FROM Dual
    ...
    /** Standard Constructor */
    public X_AD_ReportView (Properties ctx, String AD_ReportView_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, AD_ReportView_UU, trxName, virtualColumns);
      /** if (AD_ReportView_UU == null)
        {
			setAD_ReportView_ID (0);
			setAD_Table_ID (0);
...
// @SQL=SELECT CASE WHEN '@P|AdempiereSys:N@'='Y' THEN 'D' ELSE get_sysconfig('DEFAULT_ENTITYTYPE','U',0,0) END FROM Dual
    ...
    {
      StringBuilder sb = new StringBuilder ("X_AD_ReportView[")
