...
public class X_M_Lot extends PO implements I_M_Lot, I_Persistent
{
    ...
    /** Standard Constructor */
    public X_M_Lot (Properties ctx, String M_Lot_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, M_Lot_UU, trxName, virtualColumns);
      /** if (M_Lot_UU == null)
        {
			setM_Lot_ID (0);
			setM_Product_ID (0);
    ...
    {
      StringBuilder sb = new StringBuilder ("X_M_Lot[")
