...
public class X_PA_SLA_Goal extends PO implements I_PA_SLA_Goal, I_Persistent
{
    ...
    /** Standard Constructor */
    public X_PA_SLA_Goal (Properties ctx, int PA_SLA_Goal_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, PA_SLA_Goal_ID, trxName, virtualColumns);
      /** if (PA_SLA_Goal_ID == 0)
        {
			setC_BPartner_ID (0);
			setMeasureActual (Env.ZERO);
    ...
    {
      StringBuilder sb = new StringBuilder ("X_PA_SLA_Goal[")
